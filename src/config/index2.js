                ...
                if (node === extentNode) {
                    if (dom.nodeName === tagForSearch) {
                        if (dom.parentElement.nodeName !== markedTag) {
                            ...
                            if (rightData) {
                                node.replaceWith(nodeRight);
                                console.log('293 293 293');
                            } else {
                                dom.parentElement.removeChild(dom);
                                console.log('296 296 296');
                            }
                        }
                        console.log('297 297');
                    } else if (dom.nodeName !== markedTag) {
...
const addButtonForAddAndRemove = e => {
    ...
    // addMarkButton.onclick = addSelect;
    // removeMarkButton.onclick = removeSelect;
}
